...
*Femton* means fifteen in Swedish. The choice of this number plays on the elusive undertaking of the arbitrary and what would appear to imply some significance behind everything, and any naming. Incidentally, the word is related to the scientific prefix *femto-* (10e-15), linking the name to the notion of miniscule quanta, a recurring theme in this project.
